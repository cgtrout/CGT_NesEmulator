...
namespace NesEmulator {
    ...
    /*0x62*/     BAD_DEF
    /*0x63*/{   M_INDIRECTX,	OP_RRA, "RRA",		2,		8,		&NesCpu::opRRA_INDX, IT_INTERNALEXEC },
    /*0x64*/     BAD_DEF
    ...
    /*0x67*/{ M_ZEROPAGE,		OP_RRA, "RRA",		2,		5,			&NesCpu::opRRA_ZP, IT_INTERNALEXEC },
    ...
    /*0x6F*/{ M_ABSOLUTE,	OP_RRA, "RRA",			3,		6,		&NesCpu::opRRA_ABS, IT_INTERNALEXEC },
    ...
    /*0x72*/     BAD_DEF
    /*0x73*/{ M_INDIRECTY,		OP_RRA, "RRA",		2,		8,		&NesCpu::opRRA_INDY, IT_INTERNALEXEC },
    /*0x74*/     BAD_DEF
    ...
    /*0x77*/{   M_ZEROPAGEX,    OP_RRA, "RRA",      2,		    6,		    &NesCpu::opRRA_ZPX, IT_INTERNALEXEC },
    ...
    /*0x7A*/     BAD_DEF
    /*0x7B*/{    M_ABSOLUTEY, OP_RRA, "RRA",	3,		7,		&NesCpu::opRRA_ABSY, IT_INTERNALEXEC },
    /*0x7C*/     BAD_DEF
    ...
    /*0x7F*/{   M_ABSOLUTEX, OP_RRA, "RRA",	 3,		7,		&NesCpu::opRRA_ABSX, IT_INTERNALEXEC },
    /*0x80*/     BAD_DEF
